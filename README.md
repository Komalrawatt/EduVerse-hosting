...
− Aplatform for instructors to showcase their expertise and connect with learners
across the globe.
...
The ed-tech platform consists of three main components: the front end, the
